        ...
        <div class="row mt-3">
            <div class="col-lg-12 col-md-12 col-sm-12 mb-4 text-center">
                ...
                <div class="category-menu">
                    ...
                    <a href="product.php?category_name=<?php echo urlencode($category['category_name']); ?>" class="category-item">
                        <img src="admin/<?php echo htmlspecialchars($category['category_image']); ?>" alt="Category Image" style="height: 100px; width: 100px; object-fit: cover; border-radius: 5px;">
